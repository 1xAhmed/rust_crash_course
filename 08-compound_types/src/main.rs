fn main() {
    ...
    //  Tuple, tuple has the max limit to 12, you can still use it but with limited functionality
    ...
    // access the array like all others
    println!("buf at index 0 is {}", buf[0]);
}
